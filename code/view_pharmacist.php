...
?>
	...
	<ul>
			<li id="titlehead"><p id="title">View Pharmacy</p></li>
	...
	<?php
		...
		$ret=mysqli_query($conn,$sql);
            ...
            if(mysqli_num_rows($ret)==0)
            {
                      echo "<div id='card'><h1>No pharmacists exist</h1><form action='admin_home.php'><button type='submit' id='done'>Done</button></form></div>";
            }
?>
    </body>
</html>